...
public class HDFSAvroDataExtractionExecutor extends DataExtractionThread {
	...
	private static HDFSAvroDataExtractionETLJobExecutor etlJobUtil;
	
	private static final String JOB_NAME = "local_project.prifender_hdfs_arvo_v1_0_1.Prifender_HDFS_Arvo_v1";
	private static final String DEPENDENCY_JAR = "prifender_hdfs_arvo_v1_0_1.jar";
	...
	public HDFSAvroDataExtractionExecutor(DataSource ds, final DataExtractionSpec spec, final DataExtractionJob job,
		...
		etlJobUtil = new HDFSAvroDataExtractionETLJobExecutor(adapterHome);
		this.ds = ds;
