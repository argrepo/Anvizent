...
@Component
@Profile( "PostgreSql" )
public final class PostgreSqlClient extends RelationalDatabaseClient
{
    public static final String JDBC_PREFIX = "jdbc:postgresql:";
    
    @Inject
    public PostgreSqlClient( @Value( "${database.url}" ) final String url, @Value( "${database.namespace}" ) final String namespace )
    {
