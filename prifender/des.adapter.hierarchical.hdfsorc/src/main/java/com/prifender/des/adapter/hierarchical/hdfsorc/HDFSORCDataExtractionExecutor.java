...
public class HDFSORCDataExtractionExecutor extends DataExtractionThread {
	...
	private static HDFSORCDataExtractionETLJobExecutor etlJobUtil;
	
	private static final String JOB_NAME = "local_project.prifender_hdfs_orc_v1_0_1.Prifender_HDFS_ORC_v1";
	private static final String DEPENDENCY_JAR = "prifender_hdfs_orc_v1_0_1.jar";
	...
	public HDFSORCDataExtractionExecutor(DataSource ds, final DataExtractionSpec spec, final DataExtractionJob job,
		...
		etlJobUtil = new HDFSORCDataExtractionETLJobExecutor(adapterHome);
		this.ds = ds;
