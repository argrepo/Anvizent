...
public class OracleDataExtractionETLJobExecutor extends DataExtractionETLJobExecution {

	public OracleDataExtractionETLJobExecutor(final String adapterHome) {
		super(adapterHome);
	}
	...
	public Map<String, String> getContextParams(String jobFilesPath,String jobName,String dataSourceUser,
			...
			String sid,String dataSourceName ,String jobId ,String offset,String limit,String dataSourceScope, String dataSourceSampleSize
			) throws IOException {
