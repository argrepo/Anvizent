...
public class HiveDataExtractionExecutor extends DataExtractionThread {
	...
	private static HiveDataExtractionETLJobExecutor etlJobUtil;
	...
	public HiveDataExtractionExecutor(DataSource ds, final DataExtractionSpec spec, final DataExtractionJob job,
		...
		etlJobUtil = new HiveDataExtractionETLJobExecutor(adapterHome);
		this.ds = ds;
