...
public class MySQLDataExtractionExecutor extends DataExtractionThread {
	private final MySQLDataExtractionETLJobExecutor etlJobUtil;
	...
	public MySQLDataExtractionExecutor(DataSource ds, final DataExtractionSpec spec, final DataExtractionJob job,
		...
		etlJobUtil = new MySQLDataExtractionETLJobExecutor(adapterHome);
		this.ds = ds;
