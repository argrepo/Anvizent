...
public class HDFSParquetDataExtractionETLJobExecutor extends DataExtractionETLJobExecution {

	public HDFSParquetDataExtractionETLJobExecutor(String adapterHome) {
		super(adapterHome);
	}
