...
public class SqlServerDataExtractionETLJobExecutor extends DataExtractionETLJobExecution {

	public SqlServerDataExtractionETLJobExecutor(final String adapterHome) {
		super(adapterHome);
	}
