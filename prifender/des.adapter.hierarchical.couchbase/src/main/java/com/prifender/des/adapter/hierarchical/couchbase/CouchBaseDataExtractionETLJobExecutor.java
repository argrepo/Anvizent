...
public class CouchBaseDataExtractionETLJobExecutor extends DataExtractionETLJobExecution {
	
	public CouchBaseDataExtractionETLJobExecutor(final String adapterHome) {
		super(adapterHome);
	}
